...
import { ChatConversationList } from "../conversations/chat-conversation-list";
...
const SidebarChatList = () => {
  ...
  const { searchValue, getDisplayedChats, getDisplayedUnlistedUsers } = useChatStore(
  ...
  const SIDEBAR_TABS = [
    ...
    },
    {
      ...
      label: "Unread",
      count:
        chatsCount.unreadChatsCount > 0
          ? chatsCount.unreadChatsCount
    ...
    },
    {
      id: "favorite",
      label: "Favorite",
      count: chatsCount.favoriteChatsCount === 0 ? chats["favorite"]?.length || 0 : 0,
      badgeColor: "bg-yellow-100 text-yellow-600",
    },
    {
      id: "pinned",
      label: "Pinned",
      count: chatsCount.pinnedChatsCount === 0 ? chats["pinned"]?.length || 0 : 0,
      badgeColor: "bg-blue-100 text-blue-600",
    },
    {
      id: "Muted",
      label: "Muted",
      count: chatsCount.mutedChatsCount === 0 ? chats["muted"]?.length || 0 : 0,
...

    {
      id: "Archived",
      label: "Archived",
      count: chatsCount.archivedChatsCount === 0 ? chats["archived"]?.length || 0 : 0,
      badgeColor: "bg-violet-100 text-violet-600",
    },
    {
      id: "Blocked",
      label: "Blocked",
      count: chatsCount.blockedChatsCount === 0 ? chats["blocked"]?.length || 0 : 0,
      badgeColor: "bg-red-100 text-red-600",
    },
  ];
  return (
